...
// Validate game state for cashing out
    ...
    return new Promise(async (resolve, reject) => {
        try {
            ...
            if (!seedDatabase) {
                ...
                seedDatabase = await CrashSeed.create(newSeed);
            }
...
// Calculate game multiplier based on elapsed time
